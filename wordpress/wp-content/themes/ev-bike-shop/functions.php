...
if (!function_exists('ev_bike_shop_after_setup_theme')) {
	...
	function ev_bike_shop_after_setup_theme() {
		...
		if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'ev-bike-shop') {
			wp_redirect(admin_url('themes.php?page=ev_bike_shop_about'));
		}
...
define('EV_BIKE_SHOP_FREE_THEME_DOC',__('https://www.wpelemento.com/theme-documentation/ev-bike-shop/','ev-bike-shop'));
...
define('EV_BIKE_SHOP_BUY_NOW',__('https://www.wpelemento.com/elementor/bike-shop-wordpress-theme/','ev-bike-shop'));
define('EV_BIKE_SHOP_LIVE_DEMO',__('https://www.wpelemento.com/demo/ev-bike-shop/','ev-bike-shop'));
define('EV_BIKE_SHOP_PRO_DOC',__('https://www.wpelemento.com/theme-documentation/ev-bike-shop-pro/','ev-bike-shop'));
