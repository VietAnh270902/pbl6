    ...
    <div class="inner-cont">
	    ...
	    <div class="tab-sec">
	    	<div class="tab">
				...
				<button class="tablinks" onclick="ev_bike_shop_open_tab(event, 'wpelemento_importer_editor')"><?php esc_html_e( 'Demo Import', 'ev-bike-shop' ); ?></button>
			...
			<div id="wpelemento_importer_editor" class="tabcontent">
				...
				<?php }else{ ?>
					<div class="tab-outer-box">
						<h2><?php esc_html_e( 'Welcome to Elemento Theme!', 'ev-bike-shop' ); ?></h2>
						<p><?php esc_html_e( 'For setup the theme, First you need to click on the Begin activating plugins', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '1. Install Kirki Customizer Framework ', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to Required Plugins Installer ', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '2. Install WPElemento Importer', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to Required Plugins Installer ', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '3. Activate Kirki Customizer Framework ', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '4. Activate WPElemento Importer ', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '>> Then click to Return to the Dashboard', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '>> Click on the start now button', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '>> Click install plugins', 'ev-bike-shop' ); ?></p>
						<p><?php esc_html_e( '>> Click import demo button to setup the theme and click visit your site button', 'ev-bike-shop' ); ?></p>
					</div>
				<?php } ?>
			</div>
		...
		<div class="inner-side-content">
			...
			<div class="tab-outer-box">
				...
				<div class="iner-sidebar-pro-btn">
					<span class="premium-btn"><a href="<?php echo esc_url( EV_BIKE_SHOP_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'ev-bike-shop'); ?></a>
					</span>
					<span class="demo-btn"><a href="<?php echo esc_url( EV_BIKE_SHOP_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'ev-bike-shop'); ?></a>
					</span>
					<span class="doc-btn"><a href="<?php echo esc_url( EV_BIKE_SHOP_PRO_DOC ); ?>" target="_blank"><?php esc_html_e('Pro Doc', 'ev-bike-shop'); ?></a>
					</span>
				</div>
				<hr>
