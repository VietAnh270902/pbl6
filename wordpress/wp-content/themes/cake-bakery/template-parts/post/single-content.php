...
<article>
	...
	<?php
	wp_link_pages( array(
		'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'cake-bakery' ) . '</span>',
		'after'       => '</div>',
		'link_before' => '<span>',
		'link_after'  => '</span>',
		'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'cake-bakery' ) . ' </span>%',
	...
	if ( is_singular( 'attachment' ) ) {
		...
		the_post_navigation( array(
			'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'cake-bakery' ),
		) );
	} elseif ( is_singular( 'post' ) ) {
		// Previous/next post navigation.
		the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html__( 'Next', 'cake-bakery' ) . '</span> ' .
				'<span class="screen-reader-text">' . esc_html__( 'Next post:', 'cake-bakery' ) . '</span> ',
			'prev_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html__( 'Previous', 'cake-bakery' ) . '</span> ' .
				'<span class="screen-reader-text">' . esc_html__( 'Previous post:', 'cake-bakery' ) . '</span> ' ,
		) );
	}
	...
	?>
	<?php edit_post_link( esc_html__( 'Edit', 'cake-bakery' ), '<span class="edit-link">', '</span>' ); ?>
</article>	